...
describe('Test parameters extraction', () => {
  it('Extract parameters triethylamine prediction file', () => {
    ...
    expect(parameters[0]).toStrictEqual({
      ...
      atomIDs: ['H1', 'H2'],
      value: { prediction: 7.162, selected: true },
    });
    ...
    expect(parameters[1]).toStrictEqual({
      ...
      atomIDs: ['H1'],
      value: { prediction: 2.611, selected: true },
    });
    ...
    expect(parameters[2]).toStrictEqual({
      ...
      atomIDs: ['H2'],
      value: { prediction: 0.9500000000000001, selected: true },
    });
  });
  ...
  it('Extract parameters ethyl vinyl ether prediction file', () => {
    ...
    expect(parameters[2]).toStrictEqual({
      ...
      atomIDs: ['H2', 'H5'],
      value: { prediction: 7.012, selected: true },
    });
    ...
    expect(parameters[3]).toStrictEqual({
      ...
      atomIDs: ['H3', 'H4'],
      value: { prediction: 2.264, selected: false },
    });
    ...
    expect(parameters[4]).toStrictEqual({
      ...
      atomIDs: ['H1'],
      value: { prediction: 6.707, selected: true },
    });
    ...
    expect(parameters[5]).toStrictEqual({
      ...
      atomIDs: ['H2'],
      value: { prediction: 3.919, selected: true },
    });
    ...
    expect(parameters[6]).toStrictEqual({
      ...
      atomIDs: ['H3'],
      value: { prediction: 4.793, selected: false },
    });
    ...
    expect(parameters[7]).toStrictEqual({
      ...
      atomIDs: ['H4'],
      value: { prediction: 4.738, selected: false },
    });
    ...
    expect(parameters[8]).toStrictEqual({
      ...
      atomIDs: ['H5'],
      value: { prediction: 1.233, selected: false },
    });
  });
});
